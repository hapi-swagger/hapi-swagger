...
lab.experiment('plugin', () => {
  ...
  lab.test('plug-in register no vision dependency', async () => {
    try {
      ...
      expect(err.message).to.equal('Plugin @timondev/hapi-swagger missing dependency @hapi/vision');
    }
  });
  ...
  lab.test('plug-in register no inert dependency', async () => {
    try {
      ...
      expect(err.message).to.equal('Plugin @timondev/hapi-swagger missing dependency @hapi/inert');
    }
  });
