 ...
 * @return {Object}
 */
internals.properties.prototype.parseProperty = function(name, joiObj, parent, parameterType, useDefinitions, isAlt, deReferenceArrays) {
  ...
  if (property.type === 'object') {
    if (Utilities.hasJoiChildren(joiObj)) {
      property = this.parseObject(property, joiObj, name, parameterType, useDefinitions, isAlt, deReferenceArrays);
      ...
      property.name = name;
      property.properties = {
        [patternName]: this.parseProperty(patternName, objectPattern.rule, property, parameterType, useDefinitions, isAlt, deReferenceArrays),
      };
    } else {
  ...
  if (property.type === 'array') {
    property = this.parseArray(property, joiObj, name, parameterType, useDefinitions, isAlt, deReferenceArrays);

    if (useDefinitions === true && !deReferenceArrays) {
      let refName = this.definitions.append(name, property, this.getDefinitionCollection(isAlt), this.settings);
      property = {
        $ref: this.getDefinitionRef(isAlt) + refName
      };
 ...
 * @return {Object}
 */
internals.properties.prototype.parseObject = function(property, joiObj, name, parameterType, useDefinitions, isAlt, deReferenceArrays) {
  property.properties = {};
 ...
 * @return {Object}
 */
internals.properties.prototype.parseArray = function(property, joiObj, name, parameterType, useDefinitions, isAlt, deReferenceArrays) {
  const describe = joiObj.describe();
  ...
  if (arrayItem) {
    ...
    //name, joiObj, parent, parameterType, useDefinitions, isAlt
    let arrayItemProperty = this.parseProperty(itemName, arrayItem, property, parameterType, useDefinitions, isAlt, deReferenceArrays);
