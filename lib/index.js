...
internals.docs = function(settings) {
    ...
    return {
        ...
        handler: function(request, reply) {
            ...
            // supports the prefixes: '-' (exclusionary tags) or '+' (inclusionary tags)
            // e.g.: ?path=vacations&tags=mountains,beach,+horses
            //        will show routes with OPTIONAL('mountains') OR OPTIONAL('beach') REQUIRED 'horses'
            // e.g.: ?path=vacations&tags=mountains,+beach,-horses
            //        will show routes with OPTIONAL('mountains'), REQUIRED 'beach', REQUIRED NO 'horses'
