                ...
                if (settings.documentationPage === true || settings.swaggerUI === true) {
                    ...
                    filesToCopy.forEach(filename => {
                        server.route({
                            ...
                            handler: {
                                file: `${swaggerUiAssetPath}/${filename}`
                            }
                        });
                    });
                    // server.route([
                    ...
                    //                 directory: {
                    //                     path: [
                    //                         `${swaggerUiAssetPath}/favicon-16x16.png`,
                    //                         `${swaggerUiAssetPath}/favicon-32x32.png`,
                    //                         `${swaggerUiAssetPath}/index.html`,
                    //                         `${swaggerUiAssetPath}/oauth2-redirect.html`,
                    //                         `${swaggerUiAssetPath}/swagger-ui-bundle.js`,
                    //                         `${swaggerUiAssetPath}/swagger-ui-bundle.js.map`,
                    //                         `${swaggerUiAssetPath}/swagger-ui-standalone-preset.js`,
                    //                         `${swaggerUiAssetPath}/swagger-ui-standalone-preset.js.map`,
                    //                         `${swaggerUiAssetPath}/swagger-ui.css`,
                    //                         `${swaggerUiAssetPath}/swagger-ui.css.map`,
                    //                         `${swaggerUiAssetPath}/swagger-ui.js`,
                    //                         `${swaggerUiAssetPath}/swagger-ui.js.map`
                    //                     ],
                    //                     listing: false,
                    //                     index: false
                    //                 }
