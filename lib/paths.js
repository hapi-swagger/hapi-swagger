...
paths.properties = function (settings, routes) {
    ...
    routes.forEach((route) => {
        ...
        if (payloadType.toLowerCase() === 'json') {
            ...
            // set as json
            payloadParameters = Properties.parseProperty(null, route.payloadParams, swagger.definitions, swagger['x-hapi-definitions']);
            ...
            payloadParameters = Properties.toParameters(internals.getJOIObj(route, 'payloadParams'), swagger.definitions, swagger['x-hapi-definitions'], 'formData', false);
            // add form mimetype
        ...
        var pathParams = Properties.toParameters(internals.getJOIObj(route, 'pathParams'), swagger.definitions, swagger['x-hapi-definitions'], 'path', false);
        ...
        let headerParams = Properties.toParameters(internals.getJOIObj(route, 'headerParams'), swagger.definitions, swagger['x-hapi-definitions'], 'header', false);
        ...
        out.parameters = out.parameters.concat(
            headerParams,
            pathParams,
            Properties.toParameters(internals.getJOIObj(route, 'queryParams'), swagger.definitions, swagger['x-hapi-definitions'], 'query', false)
            );
