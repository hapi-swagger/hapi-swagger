...
All issues should be created using the [new issue form](https://github.com/@timondev/hapi-swagger/@timondev/hapi-swagger/issues/new).

-   Please check the "[Features from Hapi that cannot be ported to Swagger](https://github.com/@timondev/hapi-swagger/@timondev/hapi-swagger/blob/master/usageguide.md#features-from-hapi-that-cannot-be-ported-to-swagger])" section of the usage guide.
-   Try the plugin option `debug = true` to see if any errors or warning are logged. see [Debugging](https://github.com/@timondev/hapi-swagger/@timondev/hapi-swagger/blob/master/usageguide.md#debugging)
...
-   [Pull requests](https://help.github.com/articles/creating-a-pull-request/) should be made to the [master branch](https://github.com/@timondev/hapi-swagger/@timondev/hapi-swagger/tree/master).
